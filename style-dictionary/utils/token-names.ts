...
export type TypographyTokenName =
  ...
  | 'fontLinkPrimaryDecoration'
  | 'fontLinkPrimaryLetterSpacing'
...
export type BordersTokenName =
  ...
  | 'borderBadgeRadius'
  | 'borderButtonRadius'
  | 'borderCalendarGridFocusRingRadius'
  | 'borderCalendarGridRadius'
  | 'borderCodeEditorStatusDividerWidth'
  | 'borderContainerRadius'
  | 'borderContainerStickyWidth'
  | 'borderContainerTopWidth'
  | 'borderControlFocusRingRadiusCircle'
  | 'borderControlFocusRingRadiusDefault'
  ...
  | 'borderDropdownRadius'
  | 'borderDropdownVirtualOffsetWidth'
  | 'borderFieldRadius'
  | 'borderFieldWidth'
  | 'borderFlashbarRadius'
  | 'borderInvalidWidth'
  | 'borderItemRadius'
  | 'borderItemWidth'
